    ...
    <main className="flex flex-col min-h-screen items-center justify-center bg-background text-center">
      ...
      <div className="flex flex-col items-center justify-center mt-20 sm:mt-24 md:mt-30 text-center">
        <div className="text-foreground flex flex-col gap-4 px-4 sm:px-8 md:px-10 pt-6 pb-6 items-center justify-center">
          ...
          <h3 className="text-3xl sm:text-4xl md:text-5xl font-[800] mt-10 sm:mt-20">Shape Your Semester</h3>
          <h3 className="text-2xl sm:text-3xl font-[800] text-red-400">Your Way</h3>
          <p className="max-w-5xl font-[600] text-sm sm:text-base px-2">Stay ahead with smart course tracking, personalized schedules, and instant academic updates.
          ...
          <div className="flex flex-row gap-4 sm:gap-10 mt-4 flex-wrap justify-center">
            <Link href="/catalogue">
              <button className="text-black font-[800] text-sm sm:text-[15px] bg-[#f5d60b] px-6 sm:px-10 py-2 rounded hover:cursor-pointer
            ...
            <Link href="/planner">
              <button className="bg-primary text-white font-[800] text-sm sm:text-[15px] bg-accent px-6 sm:px-10 py-2 rounded hover:cursor-pointer
      ...
      <div className="flex flex-col items-center justify-center mt-10 sm:mt-15 px-4 sm:px-3">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-[800] text-foreground text-center">Unlock Your Academic Toolbox</h1>
        <h3 className="text-base sm:text-lg md:text-xl font-[700] text-foreground mt-4 sm:mt-5 text-center px-4">All the Tools You Need to Conquer TMU, All in One Place</h3>

        <div className="flex flex-col gap-6 sm:gap-8 justify-center mt-8 sm:mt-10 mb-16 sm:mb-20 w-full max-w-5xl">
          {/* Top row - 3 tools */}
          <div className="flex flex-wrap gap-4 sm:gap-8 justify-center">
            <Link href="/catalogue" className="group bg-card-bg border-2 border-input-border rounded-xl shadow-lg p-6 sm:p-8 w-full sm:w-72 md:w-80 min-h-[180px] sm:min-h-[200px] flex flex-col items-center justify-center text-center hover:cursor-pointer hover:border-primary hover:shadow-xl transition-all duration-300 hover:scale-105">
            ...
            <Link href="/planner" className="group bg-card-bg border-2 border-input-border rounded-xl shadow-lg p-6 sm:p-8 w-full sm:w-72 md:w-80 min-h-[180px] sm:min-h-[200px] flex flex-col items-center justify-center text-center hover:cursor-pointer hover:border-accent hover:shadow-xl transition-all duration-300 hover:scale-105">
            ...
            <Link href="/schedule" className="group bg-card-bg border-2 border-input-border rounded-xl shadow-lg p-6 sm:p-8 w-full sm:w-72 md:w-80 min-h-[180px] sm:min-h-[200px] flex flex-col items-center justify-center text-center hover:cursor-pointer hover:border-warning hover:shadow-xl transition-all duration-300 hover:scale-105 relative">
              <div className="w-16 h-16 bg-warning/10 rounded-full flex items-center justify-center mb-4 group-hover:bg-warning/20 transition-all duration-300">
                <svg className="w-8 h-8 text-warning" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
              </div>
              <h2 className="font-[800] text-xl mb-3 text-foreground group-hover:text-warning transition-colors duration-300">Schedule Builder</h2>
              <p className="text-sm text-muted font-[600] leading-relaxed">
                Create your ideal timetable by mixing and matching courses to avoid conflicts and optimize your week.
              </p>
              <span className="absolute top-4 right-4 text-xs bg-warning text-background px-2 py-1 rounded-full font-[700]">NEW</span>
            </Link>
          </div>
          
          {/* Bottom row - 2 tools */}
          <div className="flex flex-wrap gap-4 sm:gap-8 justify-center">
            <Link href="/transcript" className="group bg-card-bg border-2 border-input-border rounded-xl shadow-lg p-6 sm:p-8 w-full sm:w-72 md:w-80 min-h-[180px] sm:min-h-[200px] flex flex-col items-center justify-center text-center hover:cursor-pointer hover:border-success hover:shadow-xl transition-all duration-300 hover:scale-105">
            ...
            <Link href="/gpa-calculator" className="group bg-card-bg border-2 border-input-border rounded-xl shadow-lg p-6 sm:p-8 w-full sm:w-72 md:w-80 min-h-[180px] sm:min-h-[200px] flex flex-col items-center justify-center text-center hover:cursor-pointer hover:border-[#f5d60b] hover:shadow-xl transition-all duration-300 hover:scale-105">
      ...
      <h1 className="text-2xl sm:text-3xl font-[800] text-foreground p-3 text-center">Trusted by Students Across TMU...</h1>

      <div className="flex flex-col sm:flex-row flex-wrap gap-4 mb-10 mt-2 p-4 sm:p-5 w-full max-w-5xl">
        <div className="bg-white rounded-2xl p-6 shadow w-full sm:flex-1 sm:max-w-[700px] border-2 border-foreground text-black text-left">
          <div className="flex items-center gap-2 mt-4">
            ...
            <div className="min-w-0">
              ...
              <span className="block text-xs sm:text-sm text-gray-500 font-[600]">Business Technology Management, TMU</span>
            </div>
            <span className="ml-auto text-yellow-500 text-lg flex-shrink-0">★★★★★</span>
          </div>
          <p className="italic text-gray-700 mt-5 font-[600] text-sm sm:text-base">
        ...
        <div className="bg-white rounded-2xl p-6 shadow w-full sm:flex-1 sm:max-w-[700px] border-2 border-foreground text-black text-left">
          <div className="flex items-center gap-2 mt-4">
            ...
            <div className="min-w-0">
              ...
              <span className="block text-xs sm:text-sm text-gray-500 font-[600]">Computer Science, TMU</span>
            </div>
            <span className="ml-auto text-yellow-500 text-lg flex-shrink-0">★★★★★</span>
          </div>
          <p className="italic text-gray-700 mt-5 font-[600] text-sm sm:text-base">
