      ...
      <div className="flex flex-col items-center justify-center mt-15 p-3">
        ...
        <div className="flex flex-col gap-8 justify-center mt-10 mb-20">
          ...
          <div className="flex flex-wrap gap-8 justify-center">
            ...
            <Link href="/schedule" className="group bg-card-bg border-2 border-input-border rounded-xl shadow-lg p-8 w-80 min-h-[200px] flex flex-col items-center justify-center text-center hover:cursor-pointer hover:border-warning hover:shadow-xl transition-all duration-300 hover:scale-105 relative">
