          ...
          <form>
            <div className="grid gap-6">
              <div className="flex flex-col gap-4">
                <Button variant="outline" className="w-full bg-primary font-bold hover:cursor-pointer text-background">
              ...
              <div className="grid gap-6">
                ...
                <Button type="submit" className="w-full hover:cursor-pointer text-background">
                  Login
                </Button>
              </div>
