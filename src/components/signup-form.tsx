...
export function SignupForm({ className, ...props }: SignupFormProps) {
  ...
  return (
    <div
      className={cn(
        "flex flex-col gap-6 mb-10 mt-20 sm:mt-30 text-foreground rounded-[15px] w-full max-w-sm px-4 sm:px-0",
        className
      )}
      {...props}
    >
      ...
      <Card className="bg-background/10 border-2 border-foreground">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-sm">Create your TMU Pulse account</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit}>
            <div className="grid gap-5">
              ...
              <div className="text-center text-sm">
                ...
                <a href="/login" className="underline underline-offset-4 font-semibold">
                  Login
                </a>
              </div>
            </div>
