...
export default function Footer() {
  return (
    <footer className="bg-black backdrop-blur-xl text-white py-3 flex flex-col items-center gap-2 w-full text-[15px] sm:text-[14px] xs:text-[12px] border-t-4 border-red-400 z-50">
      ...
      <ul className="flex flex-row flex-wrap space-x-3 sm:space-x-0 sm:space-y-2 text-[15px] p-2 justify-center items-center">
        <li>
        ...
        <li>
          <Link href="/schedule" className="p-2 rounded-[10px] hover:underline xs:p-1 xs:text-[11px]">Schedule Builder</Link>
        </li>
        <li>
